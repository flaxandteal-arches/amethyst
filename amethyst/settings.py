...
DATATYPE_LOCATIONS.append("amethyst.datatypes")
FUNCTION_LOCATIONS.append("amethyst.functions")
ETL_MODULE_LOCATIONS.append("amethyst.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("amethyst.search_components")
...
SECRET_KEY = "django-insecure-qx2a^^p*-care&0%(b7n#xzbk61n094cpb7xi5rdrz+17_sbo*"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "amethyst.urls"
ROOT_HOSTCONF = "amethyst.hosts"

DEFAULT_HOST = "amethyst"
...
ELASTICSEARCH_PREFIX = "amethyst"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'amethyst.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = "amethyst.wsgi.application"
...
# ES_MAPPING_MODIFIER_CLASSES = ["amethyst.search.es_mapping_modifier.EsMappingModifier"]
